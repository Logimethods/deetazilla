...
docker pull logimethods/int_compose:1.5
docker pull logimethods/int_inject:1.5
docker pull logimethods/int_streaming:1.5
docker pull logimethods/int_cassandra:1.5
#docker pull logimethods/int_cassandra_inject:1.5
docker pull logimethods/int_monitor:1.5

docker network create --attachable --driver overlay deetazilla
docker stack rm deetazilla
docker pull logimethods/int_compose:1.5

docker run --rm -v `pwd`/alt_properties:/templater/alt_properties logimethods/int_compose:1.5 \
